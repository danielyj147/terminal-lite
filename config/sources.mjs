  ...
  cards: [
    ...
    },
    {
      ...
      symbols: [
        ...
        { sym: 'JPYKRW=X', label: 'JPY/KRW', dp: 3 },
    ...
    },
    {
      ...
      icon: '🛢️',
      type: 'yahoo',
      cadence: { open: 60_000, closed: 5 * MIN, session: 'us' },
      symbols: [
        { sym: 'BZ=F', label: 'Brent' },
        { sym: 'CL=F', label: 'WTI' },
        { sym: 'NG=F', label: 'NatGas', dp: 3 },
        { sym: 'GC=F', label: 'Gold' },
        { sym: 'SI=F', label: 'Silver' },
        { sym: 'HG=F', label: 'Copper' },
        { sym: 'ZC=F', label: 'Corn ¢/bu', dp: 1 },
        { sym: 'ZW=F', label: 'Wheat ¢/bu', dp: 1 },
        { sym: 'ZS=F', label: 'Soybn ¢/bu', dp: 1 },
      ],
    },
